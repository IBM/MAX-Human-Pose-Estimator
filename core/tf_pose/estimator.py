...
from core.tf_pose import common
from core.tf_pose.common import CocoPart
from core.tf_pose.tensblur.smoother import Smoother
...
class TfPoseEstimator:
    ...
    @staticmethod
    def draw_human_pose_connection(npimg, humans):
        image_h, image_w = npimg.shape[:2]
        centers = {}
        results = []
        for human in humans:
